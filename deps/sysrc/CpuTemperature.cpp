...
bool CCpuTemperature::Init() {
    switch(eCPU_TYPE) {
    case CPU_TYPE::CPU_TYPE_INTEL:
        m_pCpuTemp = new CIntelTemperature();
        break;

    case CPU_TYPE::CPU_TYPE_AMD0F:
        m_pCpuTemp = new CAMD0FTemperature();
        break;

    case CPU_TYPE::CPU_TYPE_AMD10:
        m_pCpuTemp = new CAMD10Temperature();
        break;
