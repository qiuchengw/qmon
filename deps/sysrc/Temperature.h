...
public:
    ...
    const DWORD GetCpuCoreCount()const {
...
protected:
    const DWORD _GetIoctlType()const {
        return dwIOCTL_TYPE;
    }
    const HANDLE _GetDriverHandle()const {
        return m_hDriver;
    }
    const bool _GetIsMsr()const {
        return m_bIsMsr;
    }
    const bool _GetIsNT()const {
        return m_bIsNT;
    }
    const DWORD _GetCpuCount()const {
        return m_dwCpuCount;
    }
    const unsigned short _GetFamily()const {
        return m_sFamily;
    }
    const unsigned short _GetModel()const {
        return m_sModel;
    }
    const unsigned short _GetStepping()const {
        return m_sStepping;
    }
